...
use crate::index::{LocalIndex, IndexConfig};
...
impl IndexManager {
    ...
    pub async fn create_index(&self, name: String, conf: IndexConfig) -> crate::Result<()> {
        ...
        let index = configured_builder(conf)
            .create_in_dir(&path)?;
    ...
    #[cfg(test)]
    pub fn create_test_index_in_ram(&self, name: String, schema: tantivy::schema::Schema) -> crate::Result<()> {
